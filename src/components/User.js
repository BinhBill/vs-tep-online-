...
const IS_ADMIN = "admin@learningmate.com"
...
export default function User() {
    ...
    const {id} = useParams();
    const isAdmin = email() === IS_ADMIN ? true : false;
            ...
            <div className="wrapper">
                <nav className="navbar navbar-expand navbar-light navbar-bg"
                    ...
                    <a className="sidebar-brand" href="/home">
                        <span className="align-middle">VSSTEP ONLINE</span>
                    </a>
                                        ...
                                        <div className="simplebar-content" style={{"padding": "0px", marginTop: 50}}>
                                            <ul className="sidebar-nav">
                                                ...
                                                <li className={"sidebar-item " + (url === (id === undefined ? '/exam' : '/exam/' + id) ? "active" : "")}>
                                                    <a className="sidebar-link" onClick={() => navigate('/examuser')}>
                                                        <Edit/>
                                                ...
                                                </li>
                                                {
                                                    ...
                                                    <a className="sidebar-link" onClick={() => {
                                                        ...
                                                        <CheckSquare/>
                                                        <span className="align-middle">Tạo đề thi</span>
                                                    </a>
                                                </li>
                                                    :
                                                    <>
